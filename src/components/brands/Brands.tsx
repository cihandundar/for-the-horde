                ...
                {!loading && !error && (
                    ...
                    <>
                        <div className="grid lg:grid-cols-4 grid-cols-2 gap-6">
                            {brands?.map((item) => (
                                <div key={item?.name}>
                                    <div className="shadow-xl hover:shadow-2xl rounded-lg bg-white p-10 cursor-pointer flex flex-col items-center justify-center">
                                        <img src={item.logoUrl} alt={item.name} width={100} height={100} />
